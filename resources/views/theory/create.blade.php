...
<main id="main" class="main">
    ...
    <section class="section dashboard">
        <div class="row g-1">
            <div class="col-sm-6">
                <div class="card p-2">
                    <div class="card-title">Create Theory of Change</div>
                    <div class="card-body">
                        <form action="{{ route('theory.store') }}" method="post" class="form needs-validation" novalidate>
                            @csrf <!-- Add CSRF token for form submission -->
                            <p class="my-2">The ToC you create will belong to <span class="badge bg-warning">{{ $myOrganisation->name}}</span>  organisation</p><hr>
